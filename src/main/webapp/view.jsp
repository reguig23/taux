<%-- 
    Document   : view
    Created on : 6 nov. 2019, 16:21:10
    Author     : pedago
--%>
		...
		<div class="table">
			...
			<div class="tbody">
				...
				<form class="tr" method="get">
					<div class="td"><input type="text" name="code"  readonly/></div>
					<div class="td"><input name="taux" type="number" step="0.01" min="0.0" max="99.99" size="5"/></div>
